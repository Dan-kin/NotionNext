...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '通过我们的优势资源，协助更多对法国艺术深造、就业、互动等感兴趣的个人和机构更高效的实现目标🎉',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'contact@acmfc.fr', // 邮箱地址 例如mail@tangly1024.com
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'GTM-K7QDSCHC', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '新起点-法国文化艺术之旅', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '与法国艺术界精英并肩，塑造您独特的职业道路', // 站点描述，被notion中的页面描述覆盖
